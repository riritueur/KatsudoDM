  ...
  <div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
      <ul class="nav" id="side-menu">
        ...
        <li>
          <a href="client.php"><i class="fa fa-edit fa-fw"></i> Clients</a>
        </li>
        <li>
          <a href="employe.php"><i class="fa fa-table fa-fw"></i> Employés</a>
        </li>
        <li>
        ...
        <li>
          <a href="fournisseur.php"><i class="fa fa-table fa-fw"></i> Fournisseurs</a>
        </li>
        <li>
          <a href="produit.php"><i class="fa fa-table fa-fw"></i> Produits</a>
        </li>
        <li>
          <a href="taxe.php"><i class="fa fa-table fa-fw"></i> Taxes</a>
        </li>
        <li>
